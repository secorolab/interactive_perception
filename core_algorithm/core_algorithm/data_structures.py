...
class ActionType(Enum):
    ...
    SLIDE_OVER_SURFACE_PARALLEL_TO_EDGE_WITHIN_RANGE_CCK = 17
    SLIDE_OVER_SURFACE_PARALLEL_TO_EDGE_WITHIN_RANGE_CK = 18
...
class Stop(Enum):
    ...
    UNTIL_EDGE_CONTACT_WITHIN_RANGE = "UNTIL_EDGE_CONTACT_WITHIN_RANGE"
    UNKNOWN = "UNKNOWN"
...
SPEC_TO_ACTION: Dict[ActionSpec, ActionType] = {
    ...
    ActionSpec(Direction.CCK, Mode.PARALLEL_OVER_SURFACE, Stop.UNTIL_EDGE_CONTACT_WITHIN_RANGE): ActionType.SLIDE_OVER_SURFACE_PARALLEL_TO_EDGE_WITHIN_RANGE_CCK,
    ActionSpec(Direction.CK,  Mode.PARALLEL_OVER_SURFACE, Stop.UNTIL_EDGE_CONTACT_WITHIN_RANGE): ActionType.SLIDE_OVER_SURFACE_PARALLEL_TO_EDGE_WITHIN_RANGE_CK,
